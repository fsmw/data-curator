...
class MetadataGenerator:
    ...
    def __init__(self, config):
        ...
        if self.use_llm and self.llm_config['api_key']:
            self.client = OpenAI(
    ...
    def _generate_with_llm(
        ...
        # Construct prompt
        prompt = self._build_llm_prompt(topic, data_summary, source, transformations, original_source_url)
...
"""
    ...
    def _get_from_cache(self, topic: str, data_summary: Dict[str, Any]) -> Optional[str]:
