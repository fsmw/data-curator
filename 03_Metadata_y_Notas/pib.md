...
- **Número total de observaciones**: 378
...
- `country_code`: 10 valores faltantes
- `year`: 10 valores faltantes
- `World region according to OWID`: 10 valores faltantes
- `time`: 10 valores faltantes
