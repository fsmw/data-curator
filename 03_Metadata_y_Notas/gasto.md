...
- `country_code` (object)
- `year` (float64)
- `Military expenditure (constant US$)` (float64)
...
- `year`
- `Military expenditure (constant US$)`
- `time`
- `time.1`
...
- **Número total de observaciones**: 326
...
- No se aplicaron transformaciones
...
- `country_code`: 24 valores faltantes
- `year`: 24 valores faltantes
- `Military expenditure (constant US$)`: 9 valores faltantes
- `World region according to OWID`: 24 valores faltantes
- `time`: 24 valores faltantes
